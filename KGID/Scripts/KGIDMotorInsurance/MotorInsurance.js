...
function SaveMIProposerDetails() {
    ...
    if ($('.err:visible').length === 0) {
        var ViewModel = {
            ...
            //, "mipd_type_of_cover_id": $('#ddlTypeofCover').val()
        }
...
function ValidateOtherDetails() {
    ...
    if ($('[name="miod_is_include_personal_accident_for_persons"]:checked').val() == "True") {
        ...
        if (vtype == '1') {
            ...
            if ($("#txtIsIPAname1CSI").val() != "" || $("#txtIsIPAname3CSI").val() != "" || $("#txtIsIPAname2CSI").val() != "") {

                if ($("#txtIsIPAname1CSI").val() > 100000) {
                    $("#errIsIPAnameamt1").attr("hidden", false);
                    $("#errIsIPAnameamt1").text("Cannot be greater than 1 lakh");
                    return false;
                }

                if ($("#txtIsIPAname2CSI").val() > 100000) {
                    $("#errIsIPAnameamt2").attr("hidden", false);
                    $("#errIsIPAnameamt2").text("Cannot be greater than 1 lakh");
                    return false;
                }
                if ($("#txtIsIPAname3CSI").val() > 100000) {
                    $("#errIsIPAnameamt3").attr("hidden", false);
                    $("#errIsIPAnameamt3").text("Cannot be greater than 1 lakh");
                    return false;
                }
            }
        }
        else {
            if ($("#txtIsIPAname1CSI").val() > 200000) {
                $("#errIsIPAnameamt1").attr("hidden", false);
                $("#errIsIPAnameamt1").text("Cannot be greater than 2 lakh");
                return false;
            }

            if ($("#txtIsIPAname2CSI").val() > 200000) {
                $("#errIsIPAnameamt2").attr("hidden", false);
                $("#errIsIPAnameamt2").text("Cannot be greater than 2 lakh");
                return false;
            }
            if ($("#txtIsIPAname3CSI").val() > 200000) {
                $("#errIsIPAnameamt3").attr("hidden", false);
                $("#errIsIPAnameamt3").text("Cannot be greater than 2 lakh");
                return false;
            }
        }
    ...
    if ($('[name="miod_is_include_pa_cover_for_unnamed_persons"]:checked').val() == "True") {
        ...
        if (vtype == '1') {
            ...
            if ($("#txtIsunIPAname1CSI").val() != "" || $("#txtIsunIPAname2CSI").val() != "" || $("#txtIsunIPAname3CSI").val() != "") {

                if ($("#txtIsunIPAname1CSI").val() > 100000) {
                    $("#errIsunIPAname1CSI").attr("hidden", false);
                    $("#errIsunIPAname1CSI").text("Cannot be greater than 1 lakh");
                    return false;
                }

                if ($("#txtIsunIPAname2CSI").val() > 100000) {
                    $("#errIsunIPAname2CSI").attr("hidden", false);
                    $("#errIsunIPAname2CSI").text("Cannot be greater than 1 lakh");
                    return false;
                }
                if ($("#txtIsunIPAname3CSI").val() > 100000) {
                    $("#errIsunIPAname3CSI").attr("hidden", false);
                    $("#errIsunIPAname3CSI").text("Cannot be greater than 1 lakh");
                    return false;
                }
            }
        }
        else {
            if ($("#txtIsunIPAname1CSI").val() > 200000) {
                $("#errIsunIPAname1CSI").attr("hidden", false);
                $("#errIsunIPAname1CSI").text("Cannot be greater than 2 lakh");
                return false;
            }

            if ($("#txtIsunIPAname2CSI").val() > 200000) {
                $("#errIsunIPAname2CSI").attr("hidden", false);
                $("#errIsunIPAname2CSI").text("Cannot be greater than 2 lakh");
                return false;
            }
            if ($("#txtIsunIPAname3CSI").val() > 200000) {
                $("#errIsunIPAname3CSI").attr("hidden", false);
                $("#errIsunIPAname3CSI").text("Cannot be greater than 2 lakh");
                return false;
            }
        }
...
function ValidateDocumentDetails(id) {
    if (id == 1) {
        ...
        if ($("#txtOtherDocument").val().length == 0) {
            alertify.alert("Please upload supporting documents").setHeader("Warning!!!");
            return false;
        }
        return true;
    }
        ...
        if ($("#txtDVOtherDocument").val().length == 0) {
            alertify.alert("Please upload supporting documents").setHeader("Warning!!!");
            return false;
        }
        ...
        if ($("#txtSVOtherDocument").val().length == 0) {
            alertify.alert("Please upload supporting documents").setHeader("Warning!!!");
            return false;
        }
        return true;
        ...
        //    return false;
        //}
        if ($("#txtPIVGovtSanctionDoc").val().length == 0) {
            alertify.alert("Please upload Sanction Letter from Government").setHeader("Warning!!!");
            return false;
        }
        if ($("#txtPIVProformaInvoiceDoc").val().length == 0) {
            alertify.alert("Please upload Tax Invoice").setHeader("Warning!!!");
            return false;
        }
        if ($("#txtPIVPSaleCertificateDoc").val().length == 0) {
            alertify.alert("Please upload Sale Certificate").setHeader("Warning!!!");
            return false;
        }
        if ($("#txtPIVOldInsuranceCertificate").val().length == 0) {
            alertify.alert("Please upload supporting documents").setHeader("Warning!!!");
            return false;
        }
        if ($("#txtPIVOtherDocument").val().length == 0) {
            alertify.alert("Please upload supporting documents").setHeader("Warning!!!");
            return false;
        }
        return true;
...
function ToggleVehicletype() {
    ...
    if ($('[name="ph_PurchaseType"]:checked').val() == "False") {
        ...
        $('#DonatedVehicle').hide();
        $('#SeizedVehicle').hide();
        $('#PreviouslyInsuredVehicle').hide();
       SelectCheckboxbasedonFileName();
    }
    else {
        $("#divSecondhand").show();
        ...
        if ($('#chkDonatedVehicle').is(":checked")) {
            ...
            document.getElementById("chkPreviouslyInsuredVehicle").checked = "true";
            $("#IsPreviouslyInsured").prop("checked", "checked");
            $('#NewPurchasedVehicle').hide();
            $('#DonatedVehicle').hide();
            $('#PreviouslyInsuredVehicle').show();
            $('#SeizedVehicle').hide();
        }
        SelectCheckboxbasedonFileName();
...
//function SelectCheckboxbasedonFileName() {
//    debugger;
   
 
//     var NewPurchasedVehicle = $('#txtHGovtSanctionDoc').val();
//    var DonatedVehicle = $('#txtHDonationDoc').val();
//    var PreviouslyInsuredVehicle = $('#txtHPIVGovtSanctionDoc').val();
//    var SeizedVehicle = $('#txtHcCertificateDoc').val();
...
//        $('#PreviouslyInsuredVehicle').hide();
//        $('#SeizedVehicle').hide();
//        $('#txtDonationDocFileName').show();
//        $('#txtSaleCertificateDocFileName').show();
//        $('#txtTaxInvoiceDocFileName').show();
//        $('#txtDVOtherDocFileName').show();
...
//        }
//        // $('#txtDonatedEmissionFileName').show('');
//    }
...
//    if ($('[name="ph_PurchaseType"]:checked').val() == "True") 
//    {
//        debugger;
//            if (SeizedVehicle != null && SeizedVehicle != "") {
//                document.getElementById("chkSeizedVehicle").checked = "true";
//                $('#SeizedVehicle').show();
//                $("#IsSeizedVehicle").prop("checked", "checked");
//                $('#NewPurchasedVehicle').hide();
...
//            else if (PreviouslyInsuredVehicle != null && PreviouslyInsuredVehicle != "") {
//                document.getElementById("chkPreviouslyInsuredVehicle").checked = "true";
//                $('#PreviouslyInsuredVehicle').show();
//                $("#IsPreviouslyInsured").prop("checked", "checked");
//                $('#NewPurchasedVehicle').hide();
...
function Renewalsum() {
    ...
    document.getElementById('txttotamnt').value = ReplaceNumberWithCommas(TotalPVV);
    PVVAmount = TotalPVV;
    $("#txtIDVDepreciation").val(DepreciationValue);
    //if (getmonthDiff <= 6) {
    //    var IDVTot = ((parseFloat(result)) / 100) * 5;
    //    //alert(IDVTot)
    //    if (!isNaN(IDVTot)) {
