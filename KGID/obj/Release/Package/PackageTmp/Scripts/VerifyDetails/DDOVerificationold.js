                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (typeof supportingDoc != "undefined" && typeof reimburseDoc != "undefined")
                            AddRow = "<tr data-row-number='" + result + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td><a href=" + supportingdocpath + " target='_blank'>View Document</a></td><td><a href=" + reimbursedocpath + " target='_blank'>View Document</a></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + result + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + result + ");'>Delete</a></td><td hidden>" + isreimbursed + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td><td hidden>" + result + "</td></tr>";
                        else if (typeof supportingDoc == "undefined" && typeof reimburseDoc != "undefined")
                            AddRow = "<tr data-row-number='" + result + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td></td><td><a href=" + reimbursedocpath + " target='_blank'>View Document</a></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + result + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + result + ");'>Delete</a></td><td hidden>" + isreimbursed + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td><td hidden>" + result + "</td></tr>";
                        else if (typeof supportingDoc != "undefined" && typeof reimburseDoc == "undefined")
                            AddRow = "<tr data-row-number='" + result + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td><a href=" + supportingdocpath + " target='_blank'>View Document</a></td><td></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + result + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + result + ");'>Delete</a></td><td hidden>" + isreimbursed + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td><td hidden>" + result + "</td></tr>";
                        else 
                            AddRow = "<tr data-row-number='" + result + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td></td><td></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + result + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + result + ");'>Delete</a></td><td hidden>" + isreimbursed + "</td><td hidden>" +'"'+ supportingdocpath + '"'+"</td><td hidden>" +'"'+ reimbursedocpath +'"'+ "</td><td hidden>" + result + "</td></tr>";
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (typeof supportingDoc == "undefined" && typeof editreimburseDoc == "undefined") {
                            ...
                            updatedRow = "<tr data-row-number='" + rowNumber + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td><a href=" + supportingdocpath + " target='_blank'>Click Here</a></td><td></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + rowNumber + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + rowNumber + ");'>Delete</a></td><td hidden>" + isreimburse + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td></tr>";
                        }
                        else if (typeof supportingDoc == "undefined" && typeof editreimburseDoc != "undefined") {
                            updatedRow = "<tr data-row-number='" + rowNumber + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td></td><td><a href=" + reimbursedocpath + " target='_blank'>Click Here</a></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + rowNumber + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + rowNumber + ");'>Delete</a></td><td hidden>" + isreimburse + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td></tr>";
                        }
                        else {
                            updatedRow = "<tr data-row-number='" + rowNumber + "' role='row' class='" + newClass + "'><td>" + fromDate + "</td><td>" + toDate + "</td><td>" + leaves + "</td><td>" + remarks + "</td><td><a href=" + supportingdocpath + " target='_blank'></td><td><a href=" + reimbursedocpath + " target='_blank'>View Document</a></td><td><a href='javascript: void(0);' class='btn-sm btn-primary' onclick='EditMedLeaveDetail(" + rowNumber + ");'>Edit</a>&nbsp;<a href='javascript: void(0);' class='btn-sm btn-danger' onclick='DeleteMedLeaveRow(" + rowNumber + ");'>Delete</a></td><td hidden>" + isreimburse + "</td><td hidden>" + supportingdocpath + "</td><td hidden>" + reimbursedocpath + "</td></tr>";
                        }
