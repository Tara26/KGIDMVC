...
{
    public class tbl_nb_personal_health_master
    {
        [Key]
        ...
        public Nullable<System.DateTime> phm_creation_datetime { get; set; }
        public Nullable<System.DateTime> phm_updation_datetime { get; set; }
